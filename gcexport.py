...
url_gc_gpx_activity = 'http://connect.garmin.com/proxy/activity-service-1.3/gpx/activity/'
url_gc_tcx_activity = 'http://connect.garmin.com/proxy/activity-service-1.3/tcx/activity/'
...
while total_downloaded < total_to_download:
	...
	for a in activities:
		...
		if 'sumElapsedDuration' in a['activity']:
			print a['activity']['sumElapsedDuration']['display'].encode( 'UTF-8' ) + ',',
		else:
			print '??:??:??,',
